...
// PrometheusCfg is the set of configuration data that specifies the listening
// address of the PrometheusCfg exporter.
//
//nolint:lll
type PrometheusCfg struct {
	...
	// Enable indicates whether to export tapd gRPC performance metrics to
	// Prometheus. Default is false.
	Enable bool `long:"enable" description:"enable Prometheus exporting of tapd gRPC performance metrics."`
...
// exporter.
func DefaultPrometheusCfg() PrometheusCfg {
...
func (p *PrometheusCfg) Enabled() bool {
	return p.Enable
}
